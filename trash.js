...
// 	const out = vscode.window.createOutputChannel("Orange");
// 	out.show();
// 	out.appendLine('asd')
...
// function activate(context) {
// 	this.extensionName = 'gerrronimo.green-light';
// 	this.cntx = context;
	
// 	const config = vscode.workspace.getConfiguration("green-light");
...
// 	const html = fs.readFileSync(htmlFile, "utf-8");
	...
	// 		const chromeStyles = fs.readFileSync(__dirname +'/style.css', 'utf-8');
	// 		// const jsTemplate = fs.readFileSync(__dirname +'/script.js', 'utf-8');
